...
const ModalAllDocuments = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-2xl border border-gray-200 overflow-hidden">
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg sm:text-2xl font-bold text-gray-800 truncate pr-4">
            {title}
          </h2>
          <button
            className="text-gray-400 hover:text-gray-700 transition-colors duration-200 cursor-pointer shrink-0"
            onClick={onClose}
            aria-label="Fermer"
          >
            <X className="w-6 h-6" />
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4 max-h-[70vh] overflow-y-auto">
          {documents.map((doc) => (
            <div
              key={doc.id}
              className="flex items-center gap-3 sm:gap-4 bg-gray-50 rounded-xl px-4 sm:px-6 py-4 border border-gray-200 hover:bg-gray-100 transition-all duration-200"
            >
              <div className="bg-blue-600 rounded-xl p-3 flex items-center justify-center shrink-0">
              ...
              <div className="text-blue-600 text-xs sm:text-sm font-medium w-12 sm:w-16 text-right shrink-0">
                {doc.type}
              </div>
              <button
                className="px-3 sm:px-4 py-2 rounded-lg bg-blue-600 text-white text-xs sm:text-sm font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center gap-2 cursor-pointer shrink-0"
                onClick={(e) => {
...
// Nouvelle modale de prévisualisation responsive
const PreviewModal = ({
  open,
  onClose,
  doc,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-hidden rounded-2xl bg-white border border-gray-200">
        ...
        <div className="p-5 overflow-y-auto max-h-[70vh]">
          <div className="bg-gray-50 rounded-xl w-full h-[420px] sm:h-[500px] flex items-center justify-center overflow-hidden border border-gray-200">
            <div className="text-center">
              <FileText className="w-14 h-14 sm:w-16 sm:h-16 text-blue-600 mx-auto mb-4" />
              <span className="text-gray-600 text-base sm:text-lg font-semibold">
                Aperçu du document : {doc?.name}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="flex h-full flex-col lg:flex-row">
        ...
        <div className="flex-1 p-0 pr-0 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between mb-6 sm:mb-8 gap-3 sm:gap-4">
            ...
            {canAddDocuments && (
              <button
                className="bg-blue-600 text-white px-5 sm:px-6 py-3 rounded-2xl font-semibold text-base sm:text-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 flex items-center gap-2 cursor-pointer"
          ...
          <div className="flex-1 flex flex-col gap-6 sm:gap-8 overflow-y-auto">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                ...
                <button
                  className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 transition-all duration-200 text-xs sm:text-sm rounded-xl px-3 sm:px-4 py-2 font-semibold cursor-pointer"
              ...
              <div className="space-y-3 sm:space-y-4">
                {filteredAcademique.map((doc) => (
                  <div
                    key={doc.id}
                    className="flex items-center gap-3 sm:gap-4 bg-gray-50 rounded-xl px-4 sm:px-6 py-4 cursor-pointer transition-all duration-200 hover:bg-gray-100 group border border-gray-200"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-gray-800 font-semibold text-base sm:text-lg group-hover:text-blue-600 transition-colors truncate">
                        {doc.name}
                      </div>
                      <div className="text-gray-500 text-xs sm:text-sm">
                        {doc.size}
                    ...
                    <div className="text-blue-600 text-xs sm:text-sm font-medium w-12 sm:w-16 text-right group-hover:text-blue-700 transition-colors">
                      {doc.type}
                    </div>
                    <button
                      className="px-3 sm:px-4 py-2 rounded-lg bg-blue-600 text-white text-xs sm:text-sm font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center gap-2 cursor-pointer"
                      onClick={(e) => {
                        e.stopPropagation(); /* TODO: download logic */
                      }}
                      title="Télécharger"
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                ...
                <button
                  className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 transition-all duration-200 text-xs sm:text-sm rounded-xl px-3 sm:px-4 py-2 font-semibold"
              ...
              <div className="space-y-3 sm:space-y-4">
                {filteredEntreprise.map((doc) => (
                  ...
                  >
                    ...
                    <button
                      className="px-3 sm:px-4 py-2 rounded-lg bg-blue-600 text-white text-xs sm:text-sm font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center gap-2"
                      onClick={(e) => {
                        e.stopPropagation(); /* TODO: download logic */
                      }}
                      title="Télécharger"
        ...
        {/* Supprimé: Colonne prévisualisation en desktop, remplacée par une modale */}
      </div>
