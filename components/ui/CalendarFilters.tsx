...
const CalendarFilters: React.FC<CalendarFiltersProps> = ({
  ...
  return (
    <div
      className={
        "bg-white rounded-xl shadow-sm border border-gray-200 p-3 transition-all duration-300 hover:shadow-md min-h-[124px] h-full"
      }
    >
          ...
          <div className="flex flex-wrap gap-1">
            {eventTypes.map((eventType) => (
              <button
                ...
                className={`p-1 rounded-lg text-xs font-medium transition-all duration-200 border-2 cursor-pointer ${
